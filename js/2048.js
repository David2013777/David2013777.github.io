...
function removeElements(mergedTiles) {
	...
	_isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator: _iterator[Symbol.iterator]();;) {
		...
		for (var _iterator2 = tile.mergedIds,
...
function shiftGameLeft(gameGrid) {
	...
	for (var i = 0; i < size; i++) {
		...
		for (var _iterator3 = filteredRow,
		_isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3: _iterator3[Symbol.iterator]();;) {
			var _ref3;
			if (_isArray3) {
